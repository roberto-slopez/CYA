...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clients = $em->getRepository('TSCYABundle:Client')->findAll();
    ...
    {
        $client = new Client();
        $form = $this->createForm('TS\CYABundle\Form\ClientType', $client);
    ...
    {
        $deleteForm = $this->createDeleteForm($client);
        $editForm = $this->createForm('TS\CYABundle\Form\ClientType', $client);
