...
use TS\CYABundle\Form\CourseType;
...
class CourseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $courses = $em->getRepository('TSCYABundle:Course')->findAll();
    ...
    {
        $course = new Course();
        $form = $this->createForm('TS\CYABundle\Form\CourseType', $course);
    ...
    {
        $deleteForm = $this->createDeleteForm($course);
        $editForm = $this->createForm('TS\CYABundle\Form\CourseType', $course);
